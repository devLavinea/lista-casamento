...
function App() {
  ...
  return (
    <section id='convite' className='  w-screen h-full bg-[#f5f5f5] relative overflow-hidden'>

     
      <div className=" overflow-y-scroll  convite h-screen  w-full justify-center items-center flex flex-col relative">
      <span className="h1 text-[#4a5c36] text-[17px] absolute bottom-62 "> 02 de agosto de 2026</span>
    <button  onClick={() =>
    window.open(
      "https://maps.google.com/?q=-9.389083,-40.503096",
      "_blank"
    )
  } className="shadow-button absolute bottom-43 w-43 h-10 bg-[#4a5c36] text-white rounded-md hover:bg-[#3a4c26] flex items-center justify-center gap-4">
...
<Link className="absolute bottom-30" to="/lista">
